...
var $ANOTHERBOATDPATH="../rooper/img/board_another.png";
var $charText="../rooper/kai/char.csv";
var $ruleText="../rooper/AnotherHorizon/rule.csv";
var custom=10;
var rumor=-1;//うわさ話カード
...
function checkrumor(){
	...
	var rumorcard=$("#rumorcard");
	if(rumor==-1)
		rumorcard.hide();
	else{
		rumorcard.show();
		rumorcard.css({"left":boards[rumor].x-(-20),"top":boards[rumor].y-(-20)});
	}
}
